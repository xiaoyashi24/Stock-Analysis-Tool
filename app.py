...
### What this tool does
The app helps users:
- connect to WRDS using their own WRDS username and password
...
2. Enter your **WRDS password**
3. Enter a **stock code**
4. Enter a **start month** in `YYYYMM` format
...
wrds_password = st.sidebar.text_input("Enter WRDS password", value="", type="password")
...
if run_button:
    ...
    if wrds_password.strip() == "":
        st.warning("Please enter your WRDS password.")
        st.stop()
